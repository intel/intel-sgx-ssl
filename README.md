...
Supported OpenSSL version is 1.1.1v.
...
1. Download OpenSSL package into openssl_source/ directory. (tar.gz package, e.g. openssl-1.1.1v.tar.gz)
...
1. Download OpenSSL 1.1.1v package into openssl_source/ directory. (tar.gz package, e.g. openssl-1.1.1v.tar.gz)
